...
| 测试 | pytest (59) + vitest (89) + playwright (21) |
...
| 问题 | P级 | 说明 |
|------|-----|------|
| 更广覆盖的 runtime restart/resume 仍待扩展 | P1 | V22 已补齐 coordinator recovery replay proof 与 live-activity anti-false-gap 保护，但跨更多入口与真实进程重启的覆盖仍可继续增强 |
